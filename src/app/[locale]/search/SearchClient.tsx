...
export default function SearchClient({ cities }: SearchClientProps) {
    ...
    const [cityStats, setCityStats] = useState<any>(null); // New State: { minPrice, maxPrice, ... }
    ...
    const handleSearch = async (filters: any) => {
        ...
        try {
            ...
            // Store Stats
            if (data.meta?.cityStats) {
                setCityStats(data.meta.cityStats);
            }
        } catch (e) {
            console.error(e);
        } finally {
